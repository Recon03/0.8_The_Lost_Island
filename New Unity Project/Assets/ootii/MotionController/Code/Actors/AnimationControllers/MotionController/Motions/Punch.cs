...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class Punch : MotionControllerMotion
    {
        ...
        public override void LoadAnimatorData()
        {
            ...
            STATE_Empty = mMotionController.AddAnimatorName("Fighting.Empty");
            STATE_Punch = mMotionController.AddAnimatorName("Fighting.Punch-SM.Punch");
            TRANS_Punch_Empty = mMotionController.AddAnimatorName("Fighting.Punch-SM.Punch -> Fighting.Empty");
        }
