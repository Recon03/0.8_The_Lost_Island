...
namespace com.ootii.Actors.LifeCores
{
    ...
    public interface IActorCore : ILifeCore
    {
        ...
        /// </summary>
        /// <param name="rMessage">Message sent to the actor that contains information about the damage.</param>
        ...
        /// </summary>
        /// <param name="rMessage">Message sent to the actor that contrains information about the damage.</param>
